...
class Captor(object):
    ...
    It wait till "ask_data_event" is set and then call "callback" as soon as
    data ready
    """
    _sample_rate = 16000
    ...
    def __init__(self, min_time, max_time, ask_data_event, callback,
        ...
        :param callback: Callable that will be called with data
        :param shutdown_event: Event to shutdown
        """

        if min_time > max_time:
            raise ValueError('"min_time" is greater than "max_time"')
