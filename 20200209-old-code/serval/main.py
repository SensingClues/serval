...
with open('serval/model_labels.json', 'r') as labels_file:
...
grid = column(
    ...
    row(filler2, Button(label='Unmute', callback=live_audio_callback, name='mute_button'))
)

curdoc().title = 'Serval: Sound Event Recognition-based Vigilance for Alerting and Localisation'
